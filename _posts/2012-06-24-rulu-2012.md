...
local or near events where the attendees only speak the language you want to improve. For sure, it needs a lot of curage to talk to foreign people but in the end you only can win.
